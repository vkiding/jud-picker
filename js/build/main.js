...
/***/ function(module, exports, __webpack_require__) {
	...
	var pickerModule = {
	  ...
	  pickDate: function pickDate(options, confirmCallback) {
	    ...
	    mask.className = 'jud-picker-mask';
	    var self = this;
	...
	exports.default = {
	  init: function init(Jud) {
	    Jud.registerApiModule('picker', pickerModule, meta);
	  }
	};
	...
	Picker.prototype = {
	  ...
	  _create: function _create() {
	    if (!modal) {
	      ...
	      modal.className = 'jud-picker jud-picker-fixed';
	      pickerContainer = document.createElement('div');
	      pickerHeader = document.createElement('div');
	      pickerBody = document.createElement('div');

	      pickerBar = document.createElement('div');
	      pickerBar.className = 'jud-picker-bar';

	      pickerContainer.className = 'jud-picker-content';
	      pickerHeader.className = 'jud-picker-header';
	      pickerBody.className = 'jud-picker-body';
	    ...
	    pickerConfirm.className = 'jud-picker-confirm';
	    pickerCancel.className = 'jud-picker-cancel';
	  ...
	  _createItem: function _createItem(items) {
	    ...
	    pickerScroller.className = 'jud-picker-scroller';
	  ...
	  show: function show() {
	    modal.className = 'jud-picker jud-picker-fixed jud-picker-open';
	  },

	  hide: function hide() {
	    modal.className = 'jud-picker jud-picker-fixed jud-picker-close';
	  }
	};
